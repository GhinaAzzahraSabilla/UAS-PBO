package id.ac.poliban.mi.va.ghina.contactapp_e020320006;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public DbHelper(@Nullable Context context) {
        super(context, id.ac.poliban.mi.va.ghina.contactapp_e020320006.Constants.DATABASE_NAME, null, Constants.DATABASE_VERSION);
    }
